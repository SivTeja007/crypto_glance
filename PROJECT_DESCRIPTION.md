...
|--------|------|-----------------|
| **Tejaswi** | Project Lead & Frontend Developer | Overall architecture, component development, UI implementation |
| **Siva** | Frontend Architecture Specialist | Component design patterns, state management, code structure |
| **Sadhgun** | API Integration Engineer | Data fetching, API integration, backend communication |
| **Nuthan** | UI/UX Designer | Design system, styling, responsive layouts, user experience |
| **Tushar** | Testing & Optimization Specialist | Unit tests, performance optimization, debugging |
